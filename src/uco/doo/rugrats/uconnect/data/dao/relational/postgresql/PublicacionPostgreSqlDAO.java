...
public final class PublicacionPostgreSqlDAO extends SqlDAO<PublicacionEntity> implements PublicacionDAO {
	public PublicacionPostgreSqlDAO(Connection connection) {
		super(connection);
	}
	...
	public void create(PublicacionEntity entity) {
		...
		try (var preparedStatement = getConnection().prepareStatement(sqlStatement)) {
			...
			throw UconnectDataException.create(UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_CREATE,
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.USER_MESSAGE_CREATE, exception);

		} catch (Exception exception) {
			throw UconnectDataException.create(
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_CREATE_JAVA_EXCEPTION,
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.USER_MESSAGE_CREATE, exception);
		}
	}
	...
	public List<PublicacionEntity> read(PublicacionEntity entity) {
		...
		try (var preparedstatement = getConnection().prepareStatement(sqlStatement.toString())) {
			...
			throw UconnectDataException.create(UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_READ,
	...
	public void update(PublicacionEntity entity) {
		...
		try (var preparedStatement = getConnection().prepareStatement(sqlStatement)) {
			...
			throw UconnectDataException.create(UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_UPDATE,
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.USER_MESSAGE_UPDATE, exception);

		} catch (Exception exception) {
			throw UconnectDataException.create(
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_UPDATE_JAVA_EXCEPTION,
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.USER_MESSAGE_UPDATE, exception);
		}
	}
	...
	public void delete(UUID entityId) {
		...
		try (var preparedStatement = getConnection().prepareStatement(sqlStatement)) {
			...
			throw UconnectDataException.create(UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_DELETE,
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.USER_MESSAGE_DELETE, exception);
		} catch (Exception exception) {
			throw UconnectDataException.create(
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_DELETE_JAVA_EXCEPTION,
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.USER_MESSAGE_DELETE, exception);
		}
	}
	...
	protected String preparedOrderBy() {
		return "ORDER BY pub.identificador ASC ";
	}
	...
	protected void setParameters(PreparedStatement preparedStatement, List<Object> parameters) {
		try {
			...
			throw UconnectDataException.create(
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_SET_PARAMETERS,
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.USER_MESSAGE_SET_PARAMETERS, exception);

		} catch (final Exception exception) {
			throw UconnectDataException.create(
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.TECHNICAL_MESSAGE_SET_PARAMETERS_JAVA_EXCEPTION,
					UconnectDataMessages.SqlDAO.PublicacionSqlDao.USER_MESSAGE_SET_PARAMETERS, exception);
	...
	@Override
	protected List<PublicacionEntity> executeQuery(PreparedStatement preparedStatement) {
		final List<PublicacionEntity> result = new ArrayList<>();

		try (var resultSet = preparedStatement.executeQuery()) {
			while (resultSet.next()) {
				PublicacionEntity entityTmp = PublicacionEntity.create()
						.setIdentificador(resultSet.getObject("pubid", UUID.class))
								...
								.setGrupo(GrupoEntity.create()
										...
										.setEstructura(EstructuraEntity.create()
												...
												.setOrganizacion(OrganizacionEntity.create()
														.setIdentificador(
																resultSet.getObject("pubprtgrpgrpstrorg", UUID.class))
														...
														.setTipo(TipoOrganizacionEntity.create()
																.setIdentificador(resultSet
																		.getObject("pubprtgrpgrpstrorgtp", UUID.class))
																.setNombre(
																		resultSet.getString("pubprtgrpgrpstrorgtpnm"))
																.setDescripcion(resultSet
																		.getString("pubprtgrpgrpstrorgtpdesc")))
														.setEstado(EstadoEntity.create()
																.setIdentificador(resultSet
																		.getObject("pubprtgrpgrpstrorgest", UUID.class))
																.setNombre(
																		resultSet.getString("pubprtgrpgrpstrorgestnm"))
																.setDescripcion(resultSet
												...
												.setEstado(EstadoEntity.create()
														.setIdentificador(
																resultSet.getObject("pubprtgrpgrpstrest", UUID.class))
														.setNombre(resultSet.getString("pubprtgrpgrpstrestnm"))
														.setDescripcion(resultSet.getString("pubprtgrpgrpstrestdesc"))
														.setTipoEstado(TipoEstadoEntity.create()
																.setIdentificador(resultSet
																		.getObject("pubprtgrpgrpstrteest", UUID.class))
																.setNombre(
																		resultSet.getString("pubprtgrpgrpstrteestnm"))
																.setDescripcion(resultSet
																		.getString("pubprtgrpgrpstrteestdesc")))))
										.setEstado(EstadoEntity.create()
												...
												.setTipoEstado(TipoEstadoEntity.create()
														.setIdentificador(
																resultSet.getObject("pubprtgrpgrpteest", UUID.class))
								...
								.setParticipante(ParticipanteEntity.create()
										...
										.setPersona(PersonaEntity.create()
												...
												.setTipoIdentificacion(TipoIdentificacionEntity.create()
														.setIdentificador(
																resultSet.getObject("pubprtgrpprtiptpid", UUID.class))
												...
												.setPaisTelefono(PaisEntity.create()
														.setIdentificador(
																resultSet.getObject("pubprtgrpprtipps", UUID.class))
												...
												.setEstado(EstadoEntity.create()
														.setIdentificador(
																resultSet.getObject("pubprtgrpprtipest", UUID.class))
														.setNombre(resultSet.getString("pubprtgrpprtipestnm"))
														.setDescripcion(resultSet.getString("pubprtgrpprtipestdesc"))
														.setTipoEstado(TipoEstadoEntity.create()
																.setIdentificador(resultSet
																		.getObject("pubprtgrpprtipteest", UUID.class))
																.setNombre(resultSet.getString("pubprtgrpprtipteestnm"))
																.setDescripcion(resultSet
																		.getString("pubprtgrpprtipteestdesc"))))))
								.setPuedePublicar(resultSet.getBoolean("pubprtgrpgrppdpbc")))
						.setTitulo(resultSet.getString("pubtitulo")).setContenido(resultSet.getString("pubcont"))
						.setEstado(EstadoEntity.create().setIdentificador(resultSet.getObject("pubestado", UUID.class))
